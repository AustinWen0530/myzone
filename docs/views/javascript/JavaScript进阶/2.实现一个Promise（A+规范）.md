...
class Promisex {
  constructor(fn) {
    if (typeof fn !== "function")
      throw new Error("Promisex must accept a function");
...
最后执行 promises-aplus-tests ./xxx.js 进行测试
...
[Promise 详解与实现（Promise/A+规范）](https://www.jianshu.com/p/459a856c476f)
