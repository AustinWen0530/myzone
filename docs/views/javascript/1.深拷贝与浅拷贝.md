...
- 下面分别测试 Object.assign(),lodash 中 cloneDeep,slice,concat,[...],JSON.parse(JSON.stringify),js 方法实现拷贝。
...
var object = {
  ...
  g: undefined,
  t: 123,
  c: [3, 5, { e: 1, f: 4, d: [1], s: { a: 2, b: 2 } }, { a: 1 }, 7],
};
var object2 = {
  a: undefined,
  g: 123,
...
1. 对象中只考虑自身的深拷贝可用：lodash.cloneDeep,JSON.parse(JSON.stringify()),js 方法
2. 数组中只考虑自身的深拷贝可用：lodash.cloneDeep,JSON.parse(JSON.stringify()),js 方法
